                    ...
                    <div class="notification-full-wrapper">
                            ...
                            <div class="notification-inner">
                                <div class="notification-header">
                                    ...
                                    <div class="notification-name">
                                        <div>
                                            <img src="<?php echo site_url().$data->profileImage;?>" />
                                        </div>

                                    </div>
                                    <div class="notification-tweet">
                                        <a href="<?php echo site_url().$data->username;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> Followed you - <span><?php echo timeAgo($data->created_at);?></span>
                        ...
                        <div class="notification-wrapper">
                            <div class="notification-inner">
                                ...
                                <div class="notification-tweet">
                                    <a href="<?php echo site_url().$data->profileImage;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> liked your <?php if($data->tweetBy === $user_id){echo 'Tweet';}else{echo 'Retweet';}?> - <span><?php echo timeAgo($data->created_at);?></span>
                                </div>
                                <div class="notification-footer">
                                    <div class="noti-footer-inner">
                                        <div class="noti-footer-inner-left">
                                            <div class="t-h-c-name">
                                                <span><a href="<?php echo site_url().$user->username;?>"><?php echo $user->username;?></a></span>
                                                <span>@<?php echo $user->username;?></span>
                                                <span><?php echo timeAgo($data->created_at);?></span>
                                            </div>
                                            <div class="noti-footer-inner-right-text">
                                                <?php echo getTweetlinks($data->status);?>
                                            </div>
                                        </div>
                                        <?php if(!empty($data->tweetImage)) :?>
                                        <div class="noti-footer-inner-right">
                                            <img src="<?php echo site_url().$data->tweetImage;?>" />
                                        </div>
                                        <?php endif;?>
                        ...
                        <div class="notification-wrapper">
                            <div class="notification-inner">
                                <div class="notification-header">
                                    ...
                                    <div class="notification-tweet">
                                        <a href="<?php echo site_url().$data->username;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> retweet your <?php if($data->tweetBy === $user_id){echo 'Tweet';}else{echo 'Retweet';}?> - <span><?php echo timeAgo($data->created_at);?></span>
                                    </div>
                                    <div class="notification-footer">
                                        <div class="noti-footer-inner">
                                            ...
                                            <div class="noti-footer-inner-left">
                                                <div class="t-h-c-name">
                                                    <span><a href="<?php echo site_url().$user->username;?>"><?php echo $user->screenName;?></a></span>
                                                    <span>@<?php echo $user->username;?></span>
                                                    <span><?php echo timeAgo($data->created_at);?></span>
                                                </div>
                                                <div class="noti-footer-inner-right-text">
					       ...
					       '<div class="t-show-body">
								  <div class="t-s-b-inner">
									   <div class="t-s-b-inner-in">
									     <img src="'.site_url().$tweet->tweetImage.'" class="imagePopup" data-tweet="'.$tweet->tweetID.'" data-user="'.$tweet->tweetBy.'"/>
									   </div>
								  </div>
							   </div>' : '' ) .'
...
<!--        </div>-->
        ...
        <script type='<?php echo site_url();?>text/javascript' src='assets/js/search.js'></script>
        <script type='<?php echo site_url();?>text/javascript' src='assets/js/hashtag.js'></script>
